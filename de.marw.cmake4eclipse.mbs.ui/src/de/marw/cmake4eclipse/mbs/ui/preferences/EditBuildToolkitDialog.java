 ...
 * @author Martin Weber
 */
class EditBuildToolkitDialog extends AbstractBuildToolkitDialog {
  /**
   * Creates the dialog.
   *
   * @param parentShell
   ...
   */
  public EditBuildToolkitDialog(Shell parentShell, BuildToolKitDefinition toolkit) {
    super(parentShell, toolkit, "Edit CMake Build Tool Kit");
  }
}
