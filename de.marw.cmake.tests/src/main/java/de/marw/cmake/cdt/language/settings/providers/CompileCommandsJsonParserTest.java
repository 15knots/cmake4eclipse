...
public class CompileCommandsJsonParserTest {
  ...
  private CompileCommandsJsonParser testee;

  @Before
  public void setUp() {
    testee = new CompileCommandsJsonParser();
  }
  ...
  public void testDetermineParserForCommandline_clang() {
    ParserLookupResult result = testee.determineParserForCommandline("/usr/bin/clang -C blah.c");
