...
public class CMakeErrorParser extends AbstractErrorParser implements
  ...
  public static final String CMAKE_PROBLEM_MARKER_ID = CdtPlugin.PLUGIN_ID
      + ".problem"; //$NON-NLS-1$
...
//    System.err.println("# " + line);
    ...
    case NONE:
      ...
      if ((matcher = PTN_SCRIPT_ERROR.matcher(line)).matches()) {
        ...
        pstate = PState.NONE;
        this.markerInfo = new ProblemMarkerInfo(epm.getProject(), -1,
            matcher.group(1), IMarkerGenerator.SEVERITY_ERROR_BUILD, null);
