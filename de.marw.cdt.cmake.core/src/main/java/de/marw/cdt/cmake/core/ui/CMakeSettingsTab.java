...
//  private Group group_dir;
  ...
  public void createControls(Composite parent) {
    ...
    System.out.println("isForPrefs=   " + page.isForPrefs());
    System.out.println("isForProject= " + page.isForProject());
...
//    b_dirVars = setupBottomButton(c, VARIABLESBUTTON_NAME);
    ...
    if (cfgd.isPreferenceConfiguration()) {
      ...
      try {
        ICStorageElement storage = cfgd.getStorage(
            CMakePrefPage.CFG_STORAGE_ID, false);
  ...
  protected void performApply(ICResourceDescription src,
    ...
    try {
      ICStorageElement srcEl = srcCfg.getStorage(CMakePrefPage.CFG_STORAGE_ID,
          false);
      if (srcEl != null) {
        prefs = new CMakePreferences();
        ...
        ICStorageElement dstEl = dstCfg.getStorage(
            CMakePrefPage.CFG_STORAGE_ID, true);
